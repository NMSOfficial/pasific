...
Given that the device was faulty from the outset, and considering the inconvenience this has caused, both in terms of lost productivity and the time invested in seeking a resolution, I do not consider a repair to be a satisfactory outcome. I would therefore request a full refund of GBP 1,240, the amount originally paid, rather than a replacement or repair.
